...
class LinearBlock32U8F16(nn.Module):
    """
    ...
    def enable_int8(self, weight: torch.Tensor, weight_scale: torch.Tensor) -> None:
        ...
        # flatten scale if it comes in as (blocks, 1) or similar
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        w_fp16 = self.weight.to(torch.float16) # (out, in)
        
        # Flatten and pad/reshape for block32
