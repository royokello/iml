...
@lru_cache(maxsize=1)
def _load_prebuilt_affine_high_dequant_module():
    module_name = "dequantize_from_affine_high_cuda"
    ...
    raise ModuleNotFoundError(
        "Prebuilt module 'dequantize_from_affine_high_cuda' not found. Build it first with "
        "'python setup.py build_ext --inplace' in utils/quant/cuda/affine_high."
    )
...
def dequantize_from_affine_high(
    ...
    module.dequantize_from_affine_high_fp16(
        qweight.contiguous(),
...
__all__ = ["dequantize_from_affine_high"]
